<%@ Page Title="" Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="AddApparatus.aspx.cs" Inherits="WebForm_AddApparatus" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset>
        ...
        <table id="Table1" style="border: 1px solid " cellpadding="5" cellspacing="5" frame="border" rules="all" width="100%">
            ...
            <tr>
                <td>
                    <asp:Label ID="Label15" runat="server" Text="設備名稱(英文)"></asp:Label>
            ...
            <tr>
                ...
                <td>
                    ...
                    <asp:DropDownList ID="ddlKind" runat="server" AutoPostBack="True" onselectedindexchanged="ddlKind_SelectedIndexChanged">
                    </asp:DropDownList>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="Label20" runat="server" Text="料號"></asp:Label>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label18" runat="server" Text="IMEI"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="檢查日期"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label14" runat="server" Text="保管部門"></asp:Label>
                </td>
                <td>
            ...
            <%--<tr>
                <td>
                    <asp:Label ID="Label15" runat="server" Text="保管人分機"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtCustodianExt" runat="server"></asp:TextBox>
                    <asp:Label ID="Label24" runat="server" Text="*" ForeColor="Red"></asp:Label>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label11" runat="server" Text="上傳設備照片"></asp:Label>
                </td>
                <td>
