<%@ Page Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="AddSample1.aspx.cs" Inherits="WebForm_AddSample1" Title="" %>
  ...
  <script src="../js/jquery_1.11.0.min.js"></script>
    ...
    <fieldset>
        ...
        <table id="Table1" class="one" style="border: 1px solid " cellpadding="5" cellspacing="5" frame="border" rules="all" width="100%">
            <tr>
                <td colspan=5>
                    <asp:Label ID="Label24" runat="server" Text="(*為必填項目)" ForeColor="Red"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan=2>
            ...
            <tr>
                <td colspan=2>
                    ...
                    <asp:Label ID="Label26" runat="server" Text="品名代號"></asp:Label>
            ...
            <tr>
                <td colspan=2>
                    <asp:Label ID="Label32" runat="server" Text="保管部門"></asp:Label>
                </td>
                <td colspan=3>
            ...
            <tr>
                <td colspan=2>
                    <asp:Label ID="Label27" runat="server" Text="保管代理人"></asp:Label>
                </td>
                <td colspan=3>
                    <%--<asp:TextBox ID="txtCustodian" runat="server"></asp:TextBox>--%>
            ...
            <tr>
                <td colspan=2>
                        <asp:Label ID="Label22" runat="server" Text="上傳報告/樣品照片"></asp:Label>
                </td>
                <td>
