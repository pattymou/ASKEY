<%@ Page Title="" Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="AllDailyReport.aspx.cs" Inherits="WebForm_AllDailyReport" %>
...
<%--                            <asp:TemplateField HeaderText="設備名稱" SortExpression="file_tag">
                                ...
                                <ItemTemplate>
                                    &nbsp;<asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl='<%# "DepartmentDailyReport.aspx?Value=0&ID="+Eval("ID") %>'
                                        Text='<%# Bind("Name") %>'  Target =_blank  ></asp:HyperLink>
                                </ItemTemplate>                                    
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>--%>   
                            ...
                            <asp:BoundField DataField="EndDate" HeaderText="結束日期" ReadOnly="True" SortExpression="EndDate">
                             ...
                             <asp:TemplateField HeaderText="借用單位">
