<%@ Page Title="" Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="ApparatusView.aspx.cs" Inherits="WebForm_ApparatusView" %>
  ...
  .ui-tabs-vertical .ui-tabs-panel { padding: 1em; float: right; width: 65em;}
    ...
    <fieldset>
         <table id="Table1" class="one" width="100%">
            <tr>
                <td>
                    <asp:LinkButton ID="lblAdd" runat="server" OnClick="lbtnAdd_Click">[修改設備資訊]</asp:LinkButton>
                </td>
                <td align ="right">
                    <asp:LinkButton ID="lblDel" runat="server" OnClick="lbtnDel_Click">[刪除此設備資訊]</asp:LinkButton>
                </td>
            </tr>         
         </table> 
         <br />   
         <table id="Table2" class="one" style="border: 1px solid " cellpadding="5" cellspacing="5" frame="border" rules="all" width="100%">
            <tr>
                <td>
                    <asp:Label ID="Label1" runat="server" Text="財產編號"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label2" runat="server" Text="設備名稱(中文)"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label17" runat="server" Text="設備名稱(英文)"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label21" runat="server" Text="類別"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label15" runat="server" Text="料號"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label18" runat="server" Text="廠商(中/英文)"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label20" runat="server" Text="廠商貨品編號"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label19" runat="server" Text="對應採購"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblProcurement_staff" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label13" runat="server" Text="IMEI"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label11" runat="server" Text="OS"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblOS" runat="server" Text=""></asp:Label>
                </td>
            </tr>
           <tr>
                <td>
                    <asp:Label ID="Label14" runat="server" Text="OS Ver."></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblVR" runat="server" Text=""></asp:Label>
                </td>
            </tr>                         
            <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="檢查時間"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblInspection" runat="server" Text=""></asp:Label>
                </td>
            </tr>  
            <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="保養時間"></asp:Label>
                </td>
                <td>
            ...
            <tr id="Cost" runat="server">
                <td>
                    <asp:Label ID="lblCost1" runat="server" Text="取得成本"></asp:Label>
                </td>
                <td>
            ...
            <tr id="UseYear" runat="server">
                <td>
                    <asp:Label ID="lblUseYear1" runat="server" Text="使用年限"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblUseYear" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr id="UseDays" runat="server">
                <td>
                    <asp:Label ID="lblUseDays1" runat="server" Text="使用天數"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblUseDays" runat="server" Text=""></asp:Label>
                </td>
            </tr>
            <tr id="UsePrice" runat="server">
                <td>
                    <asp:Label ID="lblUsePrice1" runat="server" Text="使用價格"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblUsePrice" runat="server" Text=""></asp:Label>
                </td>
            </tr> 
            <tr>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label9" runat="server" Text="保管人"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label16" runat="server" Text="保管代理人"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label10" runat="server" Text="設備狀態"></asp:Label>
                </td>
                <td>
                    <asp:Label ID="lblRStatus" runat="server" Text=""></asp:Label>
                </td>
            </tr>               
            <%--<tr>
                <td>
                    <asp:Label ID="Label10" runat="server" Text="Feature"></asp:Label>
                </td>
                <td>
