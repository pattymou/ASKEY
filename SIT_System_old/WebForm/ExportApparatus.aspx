<%@ Page Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" EnableEventValidation = "false" CodeFile="ExportApparatus.aspx.cs" Inherits="WebForm_ExportApparatus" Title="" %>
         ...
         <table id="Table2" class="one" style="border: 1px solid " cellpadding="5" cellspacing="5" frame="border" rules="all" width="100%">
            ...
            <td>
                ...
                <td>
                    ...
                    <asp:Label ID="Label1" runat="server" Text=" (請輸入財產編號、設備名稱、廠商或型號)"></asp:Label>
