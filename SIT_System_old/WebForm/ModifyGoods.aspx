<%@ Page Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="ModifyGoods.aspx.cs" Inherits="WebForm_ModifyGoods" Title="" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <fieldset>
        ...
        <table id="Table1" style="border: 1px solid " cellpadding="5" cellspacing="5" frame="border" rules="all" width="100%">
            <tr>
                <td>
                    <asp:Label ID="Label6" runat="server" Text="貨品名稱(中文)"></asp:Label>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="Label3" runat="server" Text="廠商(中文)"></asp:Label>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label4" runat="server" Text="廠商(英文)"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="Label14" runat="server" Text="廠牌"></asp:Label>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label5" runat="server" Text="對應採購"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label15" runat="server" Text="有效期限天數"></asp:Label>
                </td>
                <td>
                    ...
                    <%--<input type="text" id="Text1" name = "date1"  value = "<%=strDate1%>">
...
<%--            <tr>
                <td>
                    <asp:Label ID="Label11" runat="server" Text="金額"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtMoney" runat="server" Width="324px"></asp:TextBox>
                </td>
            </tr>--%>                
            <tr>
                <td>
                    <asp:Label ID="Label19" runat="server" Text="庫存數量"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtQuantity_Stock" runat="server" Width="324px"></asp:TextBox>
                </td>
            </tr>                       
             <tr>
                <td>
                    <asp:Label ID="Label7" runat="server" Text="安全存量"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtQuantity_Safety" runat="server" Width="324px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
...
<%--                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="seq" Visible="False">
                                <ItemTemplate>
                                    <asp:Label ID="lblGVSeq" runat="server" Text='<%# Bind("Goods_ID") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
