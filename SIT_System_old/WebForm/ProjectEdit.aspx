<%@ Page Title="" Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true"
    CodeFile="ProjectEdit.aspx.cs" Inherits="WebForm_ProjectEdit" %>
    ...
    <fieldset>
        ...
        <table id="Table1" class="one" style="border: 1px solid" cellpadding="5" cellspacing="5"
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label31" runat="server" Text="機種所屬Sub-PU"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label3" runat="server" Text="實驗室負責人"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label10" runat="server" Text="PM/Sales"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label12" runat="server" Text="H/W Engineer"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label29" runat="server" Text="DQA負責人"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="Label28" runat="server" Text="Jira Link"></asp:Label>
                </td>
                <td colspan="3">
                    <asp:TextBox ID="txtJira" runat="server" Width="459px"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table>
            <tr>
                <td>
                    <asp:Label ID="Label27" runat="server" Text="知會人員"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <asp:ListBox ID="listRight" runat="server" Width="321" Height="237" SelectionMode="Multiple"
                        OnSelectedIndexChanged="listRight_SelectedIndexChanged" DataTextField="Name_En">
                    </asp:ListBox>
                </td>
            </tr>
        </table>
