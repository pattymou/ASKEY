<%@ Page Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="ProjectMain.aspx.cs" Inherits="WebForm_ProjectMain" Title="" %>
...
//        alert (Local1);
        if (Local1 == "DA40")
          ...
          $('#example tbody').on('click', 'tr', function() {
              ...
              if (name != "") {
                  var url = "ProjectView1.aspx?Fun=9&Kind=" + local +"&ID=" + name;
                  location.href = (url);
              }
          });  
