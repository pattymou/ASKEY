<%@ Page Title="" Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="ReservationCancel.aspx.cs" Inherits="WebForm_ReservationCancel" %>
        ...
        <table id="Table5" class="one" width="100%">
            <tr>    
                <td>
                    ...
                    <asp:Label ID="Label18" runat="server" Text="(請輸入設備相關資訊或借用人)"></asp:Label>
