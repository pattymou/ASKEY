<%@ Page Title="" Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="StatisticsCReport.aspx.cs" Inherits="WebForm_StatisticsCReport" %>
        ...
        <table id="Table2" class="one" width="100%" >
            ...
            <tr>
                <td>
                    ...
                    <asp:Label ID="Label6" runat="server" Text="日期區間：(西元)"></asp:Label>
                    ...
                    <asp:Label ID="Label5" runat="server" Text="～(西元)"></asp:Label>
            ...
            <tr>
                <td>
                    &nbsp;&nbsp;&nbsp;&nbsp;<asp:Label ID="Label3" runat="server" Text="認証申請類別："></asp:Label>
                    <asp:DropDownList ID="ddlKind" runat="server" >
                    </asp:DropDownList>
                </td>
            </tr>
        ...
        <%--<table id="Table1" class="one" width="100%" >
            <tr style="font-size: 9pt">
                <td align="center" bgcolor="#dfe9f7" style="height: 27px">
                        <font face="新細明體" size="5">認証申請費用統計</font></td>
            </tr>
            <tr>
                <td align ="center">
