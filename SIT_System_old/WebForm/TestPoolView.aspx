<%@ Page Title="" Language="C#" MasterPageFile="~/WebForm/MasterPage.master" AutoEventWireup="true" CodeFile="TestPoolView.aspx.cs" Inherits="WebForm_TestPoolView" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <fieldset>
        <asp:LinkButton ID="LinkButton1" runat="server" onclick="linkAdd_Click">[建立新TestPool]</asp:LinkButton>
        <table id="Table1" style="border: 1px solid " cellpadding="5" cellspacing="5" frame="border" rules="all" width="100%">
            
<%--            <tr>
                <td>
                    
                    <asp:LinkButton ID="linkAdd" runat="server" onclick="linkAdd_Click">[建立新TestPool]</asp:LinkButton>
                ...
                <asp:GridView ID="gvwMain" runat="server" AutoGenerateColumns="False" CellPadding="4" ForeColor="#333333" GridLines="None"
                        ...
                        <FooterStyle BackColor="#507CD1" Font-Bold="True" ForeColor="White" />
                            <Columns>
                                ...
                                <asp:BoundField DataField="EnvironmentSetup" HeaderText="Environment Setup" ReadOnly="True" SortExpression="EnvironmentSetup">
                                    <%--<ControlStyle Width="30px"></ControlStyle>--%>
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:BoundField> 
