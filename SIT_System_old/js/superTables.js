...
//		alert (cleanRow);
//		alert (this.fixedCols);
//		alert (this.sDataTable.tBodies[0].rows[2].cells[0].offsetLeft);
//        this.sFHeaderWidth = this.sDataTable.tBodies[0].rows[2].cells[0].offsetLeft;
        if (this.fixedCols == 4)
            this.sFHeaderWidth = 510;
        else
		    this.sFHeaderWidth = this.sDataTable.tBodies[0].rows[cleanRow].cells[this.fixedCols].offsetLeft;
//		alert (this.sFHeaderWidth);
